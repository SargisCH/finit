...
export default class ValueCalculator {
  ...
  public runCalculation(
    ...
    return {
      annualRevenue: annualRevenue.toNumber(),
      developerSalaries: developerSalaries.toNumber(),
      otherDirectCost: otherDirectCost.toNumber(),
      grossProfit: grossProfit.toNumber(),
      operatingExpenses: operatingExpenses.toNumber(),
      ebidta: ebidta.toNumber(),
      ebidtaPercentage: ebidtaPercentage.toNumber(),
      tax: tax.toNumber(),
      netProfit: netProfit.toNumber(),
      profitMarginPercentage: parseInt(profitMarginPercentage.toString()),
      mrr: parseInt(mrr.toString()),
      clientConcentration: parseInt(clientConcentration.toString()),
      valuation: valueation.toNumber(),
      pMultiple: pMultiple,
      fteCorrection: fteCorrection,
      rcrCorrection: rcrCorrection,
      pFinal: pFinal.toNumber(),
      rMultiple: rMultiple,
      rFteCorrection: rFteCorrection,
      rRcrCorrection: rRcrCorrection,
      rFinal: rFinal.toNumber(),
    };
  }
}
